...
enum Error_Code{success, non_exist, duplicated_error};

template <class Record, int branch_limit> class Trie_Node;
template <class Record, int branch_limit> class Trie;
